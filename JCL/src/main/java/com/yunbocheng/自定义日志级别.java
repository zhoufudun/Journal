...
public class 自定义日志级别 {
    ...
    public  void test03() throws IOException {
        ...
        * */
        ...
        FileHandler handler = new FileHandler("/Users/zhoufudun/IdeaProjects/Journal/log/myLogTest.log");
        // 使用日志格式化组件
    ...
    public  void test04() throws IOException {
        ...
        * */
        ...
        ConsoleHandler handler = new ConsoleHandler();
        // 创建一个从指定位置输出日志信息的文件
        FileHandler handler1 = new FileHandler("/Users/zhoufudun/IdeaProjects/Journal/log/myLogTest2.log");
        handler1.setFilter(new Filter() {
            @Override
            public boolean isLoggable(LogRecord record) {
                // 如果日志信息中包含filter，则进行输出，否则不进行输出
                return record.getMessage().contains("filter");
            }
        });
